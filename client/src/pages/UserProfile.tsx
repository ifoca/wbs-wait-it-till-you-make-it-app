...
const UserProfile = () => {
  /* TO DO:
    - add logic to see if the use is logged in 
        - if yes,display regular p tags with user information 
            - have an Edit button, which once clicked, shows the edit form
                - while on edit mode, the Edit button text changes to Save Changes
  ...
  return (
    <div>
      <form className="flex flex-col gap-8 items-center m-4 p-4">
        ...
        <NavLink className="btn p-4 bg-red-600 hover:bg-red-700 text-white" to={'/user/delete'}>
          Delete Account
        </NavLink>
      </form>
    </div>
...
/* form to be enabled when user clicks "Edit Profile" button
